...
def compare_records(azara_record, rui_record):
    ...
    """
    rei_coordinate = rui_record[1][0] + rui_record[1][1]

    return rei_coordinate in azara_record
...
def clean_up(combined_record_group):
    ...
    for combined_record in combined_record_group:
        new_tuple = (combined_record[0], combined_record[2], combined_record[3], combined_record[4])
        records += str(new_tuple) + "\n"
